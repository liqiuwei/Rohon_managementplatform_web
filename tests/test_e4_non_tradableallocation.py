...
@ddt.ddt
class TestNOTradableConfiguration(unittest.TestCase):
    """全局不可交易品种/合约"""
    @classmethod
    def setUpClass(cls) -> None:
        ...
        cls.TradableConfig = cls.admin_page.click_Variety_contract_allocation2().click_Not_trading()
    ...
    def test_noTradable_a1_success(self):
        """全局不可交易品种/合约"""
        logging.info('开始测试全局不可交易品种/合约配置成功的用例')
        ...
        try:
            ...
            logging.error('测试全局不可交易品种/合约配置用例不通过')
            raise err
